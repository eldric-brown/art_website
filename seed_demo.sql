...
('home.card.1.title',   'Harbor at Dusk',                 datetime('now')),
('home.card.1.text',    'Oil on canvas · 80 x 100 cm',     datetime('now')),
('home.card.1.image',   'https://picsum.photos/seed/art-oil-1/900/1200', datetime('now')),
('home.card.1.link',    '#/works/1',                        datetime('now')),
('home.card.2.title',   'Riverside Notes',                 datetime('now')),
('home.card.2.text',    'Watercolour on paper · 38 x 56 cm', datetime('now')),
('home.card.2.image',   'https://picsum.photos/seed/art-wc-1/900/1200', datetime('now')),
('home.card.2.link',    '#/works/2',                        datetime('now')),
('home.card.3.title',   'Urban Fragments',                  datetime('now')),
('home.card.3.text',    'Graphite on paper · 29.7 x 42 cm',  datetime('now')),
('home.card.3.image',   'https://picsum.photos/seed/art-sketch-1/900/1200', datetime('now')),
('home.card.3.link',    '#/works/3',                       datetime('now'))
